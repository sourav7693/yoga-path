...
const Whatsapp: React.FC<FooterWhatsappProps> = ({
  ...
  return (
    <svg
      ...
      className={className}
    >
 <rect x="0.5" y="0.5" width="27" height="27" rx="13.5" fill="url(#paint0_radial_1_212)"/>
...
<defs>
<radialGradient id="paint0_radial_1_212" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(14 14) rotate(90) scale(14)">
<stop offset="0.322115" stop-color="white" stop-opacity="0"/>
