      ...
      >
        {testimonials.map((t: TestimonialItem, index: number) => (
          <SwiperSlide key={index}>
            <div className="group bg-gradient-to-b from-[#0052bd1a] to-[#0052bd05] rounded-xl p-6 h-[295px] flex flex-col justify-center items-center text-center transition-all duration-300 hover:bg-[#FF5900] hover:text-white">
